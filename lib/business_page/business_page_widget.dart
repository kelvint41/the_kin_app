...
class BusinessPageWidget extends StatefulWidget {
  ...
  final DocumentReference? businessRecord;
...
class _BusinessPageWidgetState extends State<BusinessPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BusinessesRecord>(
      stream: BusinessesRecord.getDocument(widget!.businessRecord!),
      builder: (context, snapshot) {
        ...
        final businessPageBusinessesRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                businessPageBusinessesRecord.name,
