...
import 'page1_welcome_mission_model.dart';
export 'page1_welcome_mission_model.dart';

class Page1WelcomeMissionWidget extends StatefulWidget {
  const Page1WelcomeMissionWidget({super.key});

  static String routeName = 'Page1WelcomeMission';
  static String routePath = '/page1WelcomeMission';

  @override
  State<Page1WelcomeMissionWidget> createState() =>
      _Page1WelcomeMissionWidgetState();
}

class _Page1WelcomeMissionWidgetState extends State<Page1WelcomeMissionWidget> {
  late Page1WelcomeMissionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Page1WelcomeMissionModel());
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                fadeOutDuration: Duration(milliseconds: 0),
                                imageUrl:
                                    'https://dimg.dreamflow.cloud/v1/image/KINVEST%20logo%2C%20elegant%20gold%20and%20black%20typography%2C%20minimalist%20and%20premium%2C%20circular%20emblem%20with%20stylized%20\'K\'%20initials%2C%20high-end%20aesthetic',
                                width: 80.0,
                                height: 80.0,
                                fit: BoxFit.contain,
                              ),
