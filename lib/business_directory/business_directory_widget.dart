...
/// "Create a dark-themed page for a business directory.
///
/// In the top section, add a Row with 3 'Card' widgets. Label them 'Total
/// Shops', 'Avg Score', and 'Users'.
///
/// Below that, add a ListView that queries the 'businesses' collection.
///
/// Each row in the list should display the business 'name' and their
/// 'k_index_score' in a gold-colored circle."
class BusinessDirectoryWidget extends StatefulWidget {
  const BusinessDirectoryWidget({super.key});

  static String routeName = 'BusinessDirectory';
  static String routePath = '/businessDirectory';
