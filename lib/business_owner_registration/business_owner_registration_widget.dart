...
import 'business_owner_registration_model.dart';
export 'business_owner_registration_model.dart';

class BusinessOwnerRegistrationWidget extends StatefulWidget {
  const BusinessOwnerRegistrationWidget({super.key});

  static String routeName = 'BusinessOwnerRegistration';
  static String routePath = '/businessOwnerRegistration';

  @override
  State<BusinessOwnerRegistrationWidget> createState() =>
      _BusinessOwnerRegistrationWidgetState();
}

class _BusinessOwnerRegistrationWidgetState
    extends State<BusinessOwnerRegistrationWidget> {
  late BusinessOwnerRegistrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessOwnerRegistrationModel());
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.categoryFilterModel1,
                              ...
                              wrapWithModel(
                                model: _model.categoryFilterModel2,
                                updateCallback: () => safeSetState(() {}),
                                child: CategoryFilterWidget(
                                  selected: false,
                                  label: 'Food & Drink',
                              ...
                              wrapWithModel(
                                model: _model.categoryFilterModel3,
                                updateCallback: () => safeSetState(() {}),
                                child: CategoryFilterWidget(
                                  selected: false,
                              ...
                              wrapWithModel(
                                model: _model.categoryFilterModel4,
                                updateCallback: () => safeSetState(() {}),
                                child: CategoryFilterWidget(
                                  selected: false,
                                  label: 'Health & Beauty',
