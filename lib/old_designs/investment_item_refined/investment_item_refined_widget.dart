...
class InvestmentItemRefinedWidget extends StatefulWidget {
  const InvestmentItemRefinedWidget({
    super.key,
    this.img_desc,
    this.name,
    this.category,
  ...
  @override
  State<InvestmentItemRefinedWidget> createState() =>
      _InvestmentItemRefinedWidgetState();
}

class _InvestmentItemRefinedWidgetState
    extends State<InvestmentItemRefinedWidget> {
  late InvestmentItemRefinedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvestmentItemRefinedModel());
  }
