      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<BusinessesRecord>(
              stream: BusinessesRecord.getDocument(widget!.businessDocument!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (columnBusinessesRecord.hasFlashBeacon)
                        Container(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        _model.updatedScore = await actions
                                            .calculateRealTimeKindex(
                                          businessProfileV2BusinessesRecord
                                              .kindexScore,
