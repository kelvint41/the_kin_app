...
class GoogleReviewCardWidget extends StatefulWidget {
  const GoogleReviewCardWidget({
    super.key,
    this.user_name,
    this.review_text,
  });
  ...
  @override
  State<GoogleReviewCardWidget> createState() => _GoogleReviewCardWidgetState();
}

class _GoogleReviewCardWidgetState extends State<GoogleReviewCardWidget> {
  late GoogleReviewCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GoogleReviewCardModel());
