...
import 'floating_search_model.dart';
export 'floating_search_model.dart';

class FloatingSearchWidget extends StatefulWidget {
  const FloatingSearchWidget({super.key});
...
class _FloatingSearchWidgetState extends State<FloatingSearchWidget> {
  late FloatingSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FloatingSearchModel());
