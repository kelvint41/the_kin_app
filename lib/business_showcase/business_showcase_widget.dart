...
class BusinessShowcaseWidget extends StatefulWidget {
  ...
  static String routeName = 'Business_Showcase';
  static String routePath = '/businessShowcase';

  @override
  State<BusinessShowcaseWidget> createState() => _BusinessShowcaseWidgetState();
}

class _BusinessShowcaseWidgetState extends State<BusinessShowcaseWidget> {
  late BusinessShowcaseModel _model;
                                ...
                                Builder(
                                  builder: (context) {
                                    ...
                                    return Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children:
                                          List.generate(galleryImages.length,
                                              (galleryImagesIndex) {
                                        final galleryImagesItem =
                                            galleryImages[galleryImagesIndex];
                                        return Expanded(
                                          child: ClipRRect(
                                            borderRadius:
