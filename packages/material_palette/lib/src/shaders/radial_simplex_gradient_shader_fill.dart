...
class RadialSimplexGradientShaderFill extends StatelessWidget {
  RadialSimplexGradientShaderFill({
    ...
    this.cache = false,
  }) : params = params ?? radialSimplexGradientDef.defaults;
  ...
  static Future<void> precacheShader() =>
      ShaderBuilder.precacheShader('packages/material_palette/shaders/radial_simplex_gradient.frag');

  void _setUniforms(FragmentShader shader, Size size, double time) {
    setShaderUniforms(shader, size, time, params, radialSimplexGradientDef.layout);
  }
  ...
  Widget build(BuildContext context) {
    return ShaderFill(
      width: width,
      height: height,
      shaderPath: 'packages/material_palette/shaders/radial_simplex_gradient.frag',
